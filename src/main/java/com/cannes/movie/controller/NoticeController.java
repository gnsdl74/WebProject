...
public class NoticeController {
	...
	public void noticeMain(Model model, Integer page, Integer perPage) {
	...
	public void noticeDetail(int noticeNo, Model model, @ModelAttribute("criteria") PageCriteria c) {
